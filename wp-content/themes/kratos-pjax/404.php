...
<html>
    ...
    <body>
        ...
        <div class="footer">
            <p> © <?php echo date('Y'); ?> <a href="<?php echo get_option('home'); ?>"><?php bloginfo('name'); ?>. All Rights Reserved.</a>
        </div>
    </body>
</html>