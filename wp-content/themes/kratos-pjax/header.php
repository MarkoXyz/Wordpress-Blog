...
<html <?php language_attributes(); ?>>
  <head>
    ...
    <style><?php
        ...
        if(kratos_option('site_rip')) echo 'html{filter: grayscale(100%);-webkit-filter: grayscale(100%);-moz-filter: grayscale(100%);-ms-filter: grayscale(100%);-o-filter: grayscale(100%);filter: progid:DXImageTransform.Microsoft.BasicImage(grayscale=1);filter: gray;-webkit-filter: grayscale(1); }';
        ?>
    </style>
  </head>
    <?php flush(); ?>
