                ...
                <article>
                    <div class="kratos-hentry kratos-post-inner clearfix">
                        <div class="kratos-post-content-l">
                            <h2 class="title-h2" style="text-align:center;font-size:18pt"><?php _e('各路大佬','moedog'); ?></h2>
                            <p style="text-align:center"><span style="color:#999999"><?php _e('随机排序，不分先后~','moedog'); ?></span></p>
                            <div class="linkpage">
                                <hr/>
                                <ul><?php
